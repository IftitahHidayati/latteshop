...
@section('container')
    ...
    <section class="gallery-area section-gap" id="gallery">
        <div class="container">
            <div class="row d-flex justify-content-center">
                <div class="menu-content pb-60 col-lg-10">
                    <div class="title text-center">
                        <h1 class="mb-10">What kind of latte we serve for you</h1>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <a href="../assets/img/latte.jpg" class="img-pop-home">
                        <img class="img-fluid" src="../assets/img/latte.jpg" alt="">
                    </a>
                    <a href="../assets/img/latte1.jpg" class="img-pop-home">
                        <img class="img-fluid" src="../assets/img/latte1.jpg" alt="">
                    </a>
                </div>
                <div class="col-lg-8">
                    <a href="../assets/img/latte2.jpg" class="img-pop-home">
                        <img class="img-fluid" src="../assets/img/latte2.jpg" alt="">
                    </a>
                    <div class="row">
                        <div class="col-lg-6">
                            <a href="../assets/img/latte3.jpg" class="img-pop-home">
                                <img class="img-fluid" src="../assets/img/latte3.jpg" alt="">
                            </a>
                        </div>
                        <div class="col-lg-6">
                            <a href="../assets/img/latte4.jpg" class="img-pop-home">
                                <img class="img-fluid" src="../assets/img/latte4.jpg" alt="">
                            </a>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 single-review">
                    ...
                    <p>
                        A lattehouse, latte shop, or latte is an establishment that primarily serves latte of various
                        types, e.g. espresso,
                        latte, and cappuccino. Some lattehouses may serve cold drinks, such as iced latte, iced coffe, and
